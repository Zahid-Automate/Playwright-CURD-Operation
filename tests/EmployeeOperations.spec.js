...
test.describe.serial('Employee CRUD Operations', () => {
    ...
    test('Add a new Employee and Delete the same employee', async({page})=>{
        console.log("Name to be Deleted is "+ randomUser.randomName);
        console.log("Name to be Deleted is "+ randomUser.phone);
        await page.goto('http://localhost:8000/');
        await page.locator("//a[contains(@href,'employees')]").first().click();
        ...
        await page.locator("//table[@id='tb-employee']//tbody//tr[last()]//td//a[@class='btn btn-danger']").click();
